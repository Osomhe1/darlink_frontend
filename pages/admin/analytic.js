      ...
      <section>
        ...
        <div className='flex flex-wrap mt-6'>
          <div class='flex flex-col items- w-full max-w-screen-md p-6 pb-6 mt-10 bg-white rounded-lg shadow-xl sm:p-8'>
            <h1 className='text-3xl text-[#8BC940] font-semibold'>Clients</h1>

            <div className=' mt-12 flex gap-4    '>
              <div className='w-1/2 border p-5 '>
                <h2 className='text-2xl p-3 text-[#8BC940] '>Today</h2>
                <div className=' '>
              ...
              <div className='w-1/2 border p-5 '>
                <h2 className='text-2xl p-3 text-[#8BC940] '>All Time</h2>
                <div className='  '>
        ...
        <div class=' items-center w-full max-w-screen-md p-6 pb-6 mt-10 gap-6 bg-white rounded-lg shadow-xl sm:p-8'>
          <h1 className='text-3xl font-semibold text-[#8BC940]'>Clicks</h1>
